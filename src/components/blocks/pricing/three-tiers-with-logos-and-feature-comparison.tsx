                        ...
                        if (typeof tierValue === 'string') {
                          return (
                            <>
                              ...
                              <span className="text-sm/6 text-gray-950">{tierValue}</span>
                            </>
                          );
                        } else {
                          return (
                        ...
                        >
                          ...
                          <dd className="text-center">
                            {(() => {
                              const tierValue = feature.tiers[tier.name];
                              if (typeof tierValue === 'string') {
                                return <span className="text-sm/6 text-gray-950">{tierValue}</span>;
                              } else {
                                return (
                                  <>
                                    {tierValue === true ? (
                                    ...
                                    <span className="sr-only">{tierValue === true ? 'Yes' : 'No'}</span>
                                  </>
                                );
                              }
                            })()}
